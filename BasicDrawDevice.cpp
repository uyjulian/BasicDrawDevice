...
#define TVPBasicDrawDeviceDoesNotSupporteLayerManagerMoreThanOne TJS_W("\"basic draw\" device does not support layer manager more than 1")
#define TVPBasicDrawDeviceFailedToCreateDirect3DDevice TJS_W("BasicDrawDevice: Failed to create Direct3D Device: %1")
#define TVPBasicDrawDeviceFailedToCreateDirect3DDeviceUnknownReason TJS_W("BasicDrawDevice: Failed to create Direct3D Device: unknown reason")
#define TVPBasicDrawDeviceFailedToCreateDirect3DDevices TJS_W("BasicDrawDevice: Failed to create Direct3D devices: %1")
#define TVPBasicDrawDeviceFailedToCreateDirect3DDevicesUnknownReason TJS_W("BasicDrawDevice: Failed to create Direct3D devices: unknown reason")
#define TVPBasicDrawDeviceInfDirect3DDevicePresentFailed TJS_W("BasicDrawDevice: (inf) IDirect3DDevice::Present failed/HR=%1")
#define TVPBasicDrawDeviceInfPolygonDrawingFailed TJS_W("BasicDrawDevice: (inf) Polygon drawing failed/HR=%1")
#define TVPBasicDrawDeviceTextureHasAlreadyBeenLocked TJS_W("BasicDrawDevice: Texture has already been locked (StartBitmapCompletion() has been called twice without EndBitmapCompletion()), unlocking the texture.")
#define TVPCannotAllocateD3DOffScreenSurface TJS_W("Cannot allocate D3D off-screen surface/HR=%1")
#define TVPD3dErrCannotProtectContent TJS_W("D3D : The specified content cannot be protected.")
#define TVPD3dErrConflictioningRenderState TJS_W("D3D : The currently set render states cannot be used together.")
#define TVPD3dErrConflictioningTextureFilter TJS_W("D3D : The current texture filters cannot be used together.")
#define TVPD3dErrConflictioningTexturePalette TJS_W("D3D : The current textures cannot be used simultaneously.")
#define TVPD3dErrDeviceHung TJS_W("D3D : The device that returned this code caused the hardware adapter to be reset by the OS.")
#define TVPD3dErrDeviceLost TJS_W("D3D : The device has been lost but cannot be reset at this time.")
#define TVPD3dErrDeviceNotReset TJS_W("D3D : The device has been lost but can be reset at this time.")
#define TVPD3dErrDeviceRemoved TJS_W("D3D : The hardware adapter has been removed.")
#define TVPD3dErrDriverIinternalError TJS_W("D3D : Internal driver error. Applications should destroy and recreate the device when receiving this error. ")
#define TVPD3dErrDriverInvalidCall TJS_W("D3D : Not used.")
#define TVPD3dErrFail TJS_W("D3D : An undetermined error occurred inside the Direct3D subsystem.")
#define TVPD3dErrInvalidArg TJS_W("D3D : An invalid parameter was passed to the returning function.")
#define TVPD3dErrInvalidCall TJS_W("D3D : The method call is invalid. For example, a method's parameter may not be a valid pointer.")
#define TVPD3dErrInvalidDevice TJS_W("D3D : The requested device type is not valid.")
#define TVPD3dErrMoreData TJS_W("D3D : There is more data available than the specified buffer size can hold.")
#define TVPD3dErrNotAvailable TJS_W("D3D : This device does not support the queried technique.")
#define TVPD3dErrNotFound TJS_W("D3D : The requested item was not found.")
#define TVPD3dErrOutOfMemory TJS_W("D3D : Direct3D could not allocate sufficient memory to complete the call.")
#define TVPD3dErrOutOfVideoMemory TJS_W("D3D : Direct3D does not have enough display memory to perform the operation. ")
#define TVPD3dErrPresentStatisticsDisJoint TJS_W("D3D : The present statistics have no orderly sequence.")
#define TVPD3dErrTooManyOperations TJS_W("D3D : The application is requesting more texture-filtering operations than the device supports.")
#define TVPD3dErrUnsuportedAalphtOperation TJS_W("D3D : The device does not support a specified texture-blending operation for the alpha channel.")
#define TVPD3dErrUnsuportedAlphaArg TJS_W("D3D : The device does not support a specified texture-blending argument for the alpha channel.")
#define TVPD3dErrUnsuportedColorArg TJS_W("D3D : The device does not support a specified texture-blending argument for color values.")
#define TVPD3dErrUnsuportedColorOperation TJS_W("D3D : The device does not support a specified texture-blending operation for color values.")
#define TVPD3dErrUnsuportedFactorValue TJS_W("D3D : The device does not support the specified texture factor value. Not used; provided only to support older drivers.")
#define TVPD3dErrUnsupportedCrypto TJS_W("D3D : The specified cryptographic algorithm is not supported.")
#define TVPD3dErrUnsupportedOverlay TJS_W("D3D : The device does not support overlay for the specified size or display mode. ")
#define TVPD3dErrUnsupportedOverlayFormat TJS_W("D3D : The device does not support overlay for the specified surface format. ")
#define TVPD3dErrUnsupportedTextureFilter TJS_W("D3D : The device does not support the specified texture filter.")
#define TVPD3dErrWasStillDrawing TJS_W("D3D : The previous blit operation that is transferring information to or from this surface is incomplete.")
#define TVPD3dErrWrongTextureFormat TJS_W("D3D : The pixel format of the texture surface is not valid.")
#define TVPD3dOkNoAutoGen TJS_W("D3D : This is a success code. However, the autogeneration of mipmaps is not supported for this format.")
#define TVPD3dUnknownError TJS_W("D3D : Unknown error.")
#define TVPFaildToCreateDirect3D TJS_W("Faild to create Direct3D9.")
#define TVPFaildToCreateDirect3DDevice TJS_W("Faild to create Direct3D9 Device.")
#define TVPFaildToDecideBackbufferFormat TJS_W("Faild to decide backbuffer format.")
#define TVPFaildToSetRenderState TJS_W("Faild to set render state.")
#define TVPFaildToSetViewport TJS_W("Faild to set viewport.")
#define TVPInternalErrorResult TJS_W("Internal error/HR=%1")
#define TVPUsePowerOfTwoSurface TJS_W("Use power of two surface.")
#define TVPWarningImageSizeTooLargeMayBeCannotCreateTexture TJS_W("warning : Image size too large. May be cannot create texture.")
...
void tTVPBasicDrawDevice::EnsureDevice()
{
	...
	if( TargetWindow ) {
		struct EnsureDeviceTryCatchBlock {
		...
		TVPDoTryBlock(&EnsureDeviceTryCatchBlock::Try, &EnsureDeviceTryCatchBlock::Catch, NULL, (void*)this);
	}
}
//---------------------------------------------------------------------------
...
{
	switch (r) {
	case TJS_E_ACCESSDENYED:   TVPThrowExceptionMessage( TVPBasicDrawDeviceDoesNotSupporteLayerManagerMoreThanOne ); break;
	case TJS_E_MEMBERNOTFOUND: TVPThrowExceptionMessage( TJS_W("\"basic draw\" device removed unknown layer manager") ); break;
	}
}
//---------------------------------------------------------------------------
...
tTJSNativeClassForPlugin* tTJSNC_BasicDrawDevice::CreateNativeClass()
#endif
{
#if 1
	tTJSNativeClassForPlugin * classobj =
		TJSCreateNativeClassForPlugin(TJS_W("BasicDrawDevice"), &tTJSNC_BasicDrawDevice::CreateNativeInstance);
#endif
...
{
	Device = new tTVPBasicDrawDeviceWrapper();
}
//---------------------------------------------------------------------------
tTJSNI_BasicDrawDevice::~tTJSNI_BasicDrawDevice()
{
